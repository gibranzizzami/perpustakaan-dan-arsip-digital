...
Jaringan komputer dikategorikan berdasarkan cakupan wilayahnya:

- **LAN (Local Area Network)**: Jaringan dalam satu kantor atau gedung.
- **WAN (Wide Area Network)**: Jaringan yang mencakup antar kota atau negara.
...
- **Virus**: Program yang menyebar dan menginfeksi perangkat.
- **Trojan**: Program yang tampak normal tetapi memiliki fungsi tersembunyi untuk merusak sistem.
- **Spyware**: Program yang memata-matai aktivitas pengguna tanpa izin.
...
Langkah-langkah keamanan jaringan yang harus diterapkan:

### Keamanan Komputer:
- Menggunakan enkripsi data.
- Memasang firewall untuk mengontrol lalu lintas jaringan.
- Menggunakan kata sandi yang kuat dan menggantinya secara berkala.

### Keamanan Jaringan:
- Memantau lalu lintas data secara berkala.
